            ...
            <div class="navbar-collapse">
				<nav class="cbp-spmenu cbp-spmenu-vertical cbp-spmenu-left" id="cbp-spmenu-s1">
					<ul class="nav" id="side-menu">
						<li>
							<a href="Addcase.jsp"><i class="fa fa-home nav_icon"></i> Add Case </a>
						</li>
						...
						<thead> <tr> <th>#</th>
						 ...
						 <th>View Comments</th>
						  ...
						  try
						  {
							  ...
							  PreparedStatement ps8 = con.prepareStatement("select * from addcase where aid=?");
							  ps8.setInt(1,aid);
						  ...
						  <td><a href="ArogyaViewComment.jsp?pid=<%= rs5.getInt(1)%>">View Comment</a></td>
